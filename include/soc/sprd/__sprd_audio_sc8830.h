...
static inline int arch_audio_vbc_tuned26m_clock_sel(int tuned)
{
	return 0;
}
/* ------------------------------------------------------------------------- */
...
#if FIXED_AUDIO
	ret = sci_adi_write((reg + CODEC_AP_OFFSET + ANA_AUDCFGA_INT_BASE - CODEC_AP_BASE), val, mask);
#endif
...
#if FIXED_AUDIO
	ret = sci_adi_write((reg + CODEC_AP_OFFSET + ANA_AUDCFGA_INT_BASE - CODEC_AP_BASE), val, 0xFFFF);
#endif
...
#if FIXED_AUDIO
	ret = sci_adi_read(reg + CODEC_AP_OFFSET + ANA_AUDCFGA_INT_BASE - CODEC_AP_BASE);
#endif
...
{
#if FIXED_AUDIO
	sci_glb_clr(REG_PMU_APB_MEM_PD_CFG0, BITS_AON_MEM_PD_CFG_VBC(3));
	sci_glb_clr(REG_PMU_APB_MEM_PD_CFG0, BITS_AON_MEM_PD_CFG_AUD(3));
#endif
	return 0;
}
...
{
#if FIXED_AUDIO
	sci_glb_set(REG_PMU_APB_MEM_PD_CFG0, BITS_AON_MEM_PD_CFG_VBC(1));
	sci_glb_set(REG_PMU_APB_MEM_PD_CFG0, BITS_AON_MEM_PD_CFG_AUD(1));
#endif
	return 0;
}
...
#define AUDIO_VBC_REG_DUMP_LIST(t) { \
	REG_PAIR(t, REG_AON_APB_APB_EB0,         1, __raw_readl) \
	REG_PAIR(t, REG_AON_APB_APB_RST0,		 1, __raw_readl) \
	REG_PAIR(t, REG_AON_APB_SINDRV_CTRL,	 1, __raw_readl) \
	REG_PAIR(t, REG_AON_APB_VBC_CTRL,		 1, __raw_readl) \
	REG_PAIR(t, REG_AON_APB_AP_WPROT_EN,	 1, __raw_readl) \
	REG_PAIR(t, REG_AON_APB_CP0_WPROT_EN,    1, __raw_readl) \
	REG_PAIR(t, REG_AON_APB_CP1_WPROT_EN,    1, __raw_readl) \
	REG_PAIR(t, REG_AON_APB_CP2_WPROT_EN,    1, __raw_readl) \
}

#define AUDIO_CODEC_REG_DUMP_LIST(t) { \
	REG_PAIR(t, SPRD_INTC0_BASE,             4, __raw_readl) \
	REG_PAIR(t, REG_PMU_APB_SLEEP_CTRL,      1, __raw_readl) \
	REG_PAIR(t, REG_PMU_APB_MEM_PD_CFG0,     1, __raw_readl) \
	REG_PAIR(t, ANA_AUDIFA_INT_BASE,         1, sci_adi_read) \
	REG_PAIR(t, ANA_REG_GLB_ARM_MODULE_EN,   1, sci_adi_read) \
	REG_PAIR(t, ANA_REG_GLB_ARM_CLK_EN,      1, sci_adi_read) \
	REG_PAIR(t, ANA_REG_GLB_AUD_SLP_CTRL,    1, sci_adi_read) \
	REG_PAIR(t, ANA_REG_GLB_AUDIO_CTRL0,     1, sci_adi_read) \
	REG_PAIR(t, ANA_REG_GLB_RTC_CLK_EN,      1, sci_adi_read) \
	REG_PAIR(t, ANA_REG_GLB_XTL_WAIT_CTRL,   1, sci_adi_read) \
	REG_PAIR(t, ANA_REG_GLB_ARM_RST,         1, sci_adi_read) \
}

#define AUDIO_IIS_REG_DUMP_LIST(t) { \
	REG_PAIR(t, REG_AP_APB_APB_EB,           1, __raw_readl) \
	REG_PAIR(t, REG_AP_APB_APB_RST,          1, __raw_readl) \
}
/*
REG_PAIR(t, ANA_REG_GLB_AUDIO_CTRL,      1, sci_adi_read) \
REG_PAIR(t, ANA_REG_GLB_AUD_SLP_CTRL4,   1, sci_adi_read) \
*/
