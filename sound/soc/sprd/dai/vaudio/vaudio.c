			       ...
			       struct snd_soc_dai *dai)
{
	...
	/* For call, use tuned 26M clock for vbc and pmic. */
	arch_audio_vbc_tuned26m_clock_sel(1);
				 ...
				 struct snd_soc_dai *dai)
{
	...
	/* For non-call, use un-tuned 26M clock for vbc and pmic. */
	arch_audio_vbc_tuned26m_clock_sel(0);
}
