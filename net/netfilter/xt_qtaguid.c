			 ...
			 int cnt_set)
{
	...
	/* FIXME - just work around for cts pass ...
	 * Do not dump all uid's stats even if the acct_tag is zero, otherwise
	 * CTS com.android.cts.appsecurity.AppSecurityTests--
	 * testAppFailAccessPrivateData will fail!.
	 */
