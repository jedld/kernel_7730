...
#define REG_AON_APB_RPLL_CFG3                          SCI_ADDR(REGS_AON_APB_BASE, 0x00A8)
...
/* bits definitions for register REG_AON_APB_RPLL_CFG3 */
#define BITS_AUD_TUNED_26M                                (BIT(31))
#define BITS_RPLL_CFG3_MUX1                               (BIT(26))
